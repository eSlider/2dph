...
func TestCacheKeyStable(t *testing.T) {
	if CacheKey("LadybugDB", nil) != CacheKey("LadybugDB", map[string]string{}) {
		t.Fatal("nil vs empty params")
	}
	if CacheKey("  LadybugDB ", nil) != CacheKey("ladybugdb", nil) {
