...
name: web-search
description: >-
  Search the public web through the self-hosted SearXNG at search.produktor.io
...
## PHI: this query leaves the host

The search goes to external engines. Never put a patient or staff identifier in
