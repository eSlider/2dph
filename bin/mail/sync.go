...
// bin/mail/sync.go - async download of OnlyOffice, Gmail and M365 mail to var/corpus/mail/.
//
...
//
// Writes raw message.json + attachments under var/corpus/mail/<folder>/<id>/; run
